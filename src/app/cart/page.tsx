...
export default function CartPage() {
  ...
  // Pricing (estimates until we have lab pricing)
  const estimatedPerTest = 1000 // placeholder avg
  ...
  return (
    <div className="animate-fade-up min-h-screen">
      ...
      <div style={{ background: 'var(--teal-dark)', padding: '16px 20px 18px' }}>
        ...
        <div className="text-[11px] text-white/50 pl-0.5">
        ...
        {cart.length === 0 ? (
          ...
          <div className="p-16 text-center">
            ...
            <Link href="/search" className="no-underline">
              <button className="btn btn-teal">Search for tests →</button>
            </Link>
          </div>
        ) : (
          <>
            ...
            <div className="px-5 pt-4">
              {cart.map(t => (
                <div key={t.id} className="bg-white rounded-[var(--r)] border-[1.5px] border-[var(--border)] p-4 mb-2.5 flex items-center gap-3"
                  ...
                  <div className="w-[42px] h-[42px] rounded-[11px] flex items-center justify-center text-xl shrink-0"
            ...
            <div className="mx-5 mb-3">
              <div className="text-[11px] font-bold text-[var(--text-soft)] uppercase tracking-wider mb-2.5">
                Collection summary — one visit
              </div>
            ...
            {cart.length >= 2 && (
              <div className="mx-5 mb-3">
                <div className="rounded-[var(--r)] p-3 px-3.5 flex gap-2.5 items-center"
                  ...
                  <div>
                    ...
                    <div className="text-[11px] mt-0.5" style={{ color: '#065F46' }}>
                      All tests at same lab — 5% off (KES {discount.toLocaleString()} saved)
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-5 mb-4">
              <div className="bg-white rounded-[var(--r)] border-[1.5px] border-[var(--border)] p-3.5 px-4"
                   style={{ boxShadow: 'var(--sh)' }}>
                <div className="text-[12px] font-bold text-[var(--text-soft)] uppercase tracking-wider mb-2.5">
                  Estimated fees
                </div>
                ...
                <div className="text-[10px] text-[var(--text-soft)] mt-1.5 leading-relaxed">
                  * Final fees confirmed when you choose a lab. Rider fee: KES 300 per visit (one rider, all samples).
                </div>
              </div>
            </div>
          </>
      ...
      {cart.length > 0 && (
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] md:max-w-5xl px-5 pb-6 pt-3.5 bg-white border-t-[1.5px] border-[var(--border)] z-50">
          <button className="btn btn-teal text-[15px]"
                  onClick={() => alert('Lab comparison coming next!')}>
